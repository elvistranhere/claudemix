...
Glob and Grep are not available on this lane; Bash, Read, WebFetch, and WebSearch are. Use Bash for file discovery and search (rg, find, ls) rather than reporting that you cannot look something up."""
